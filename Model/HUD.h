...
protected:
    ...
    Item firstCollRaw[2] = {{"Anima del Guardiano", 0,
        "Anima del leone alato bianco, protettore del Santuario, che temeva la diffusione dell'abisso", 1, 0, 396, 73, 18, 22}, 
    ...
    Item secCollRaw[2] = {{"Anima di Artorias", 0, "Anima di un cavaliere valoroso, che è stato consumato dall'Abiosso. "
        ...
        "il quale ha veramente sconfitto l'Abisso", 1, 0, 440, 73, 18, 22}, {"Testa Stregone di Oolacile", 0, "Creature che somigliano "
